...
"$PYTHON" analysis/analyze_journal_latents.py \
  ...
  --out-dir analysis/plots_large_fonts \
  --font-size "$FONT_SIZE" \
  --no-figure-titles
...
"$PYTHON" analysis/recompute_revision_validation.py \
  --reuse-artifacts \
  --device cpu \
  --num-workers 0 \
  --font-size "$FONT_SIZE"

MANUSCRIPT_DIR="analysis/plots_large_fonts_figures_paper"
...
cp -f analysis/plots_large_fonts/figures_paper/paper_figure_2_navigation_gate.png \
  "$MANUSCRIPT_DIR/paper_figure_2_navigation_gate.png"
cp -f analysis/plots_large_fonts/figures_paper/paper_figure_3_risk_calibration.png \
  "$MANUSCRIPT_DIR/paper_figure_3_risk_calibration.png"
cp -f analysis/plots_large_fonts/figures_paper/paper_figure_4_latent_manifold.png \
...
cp -f analysis/revision_validation_analysis/figures/validation_risk_calibration.png \
