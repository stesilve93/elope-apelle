...
from elope.utils import load_yaml, angles_to_quat, quat_rotate, angles_to_dcm
...
class FlowEncoder(nn.Module): 
    ...
    def __init__(
        ...
        c1, c2, c3, c4, c5 = 7, 64, 128, 256, 512
        ...
        self.layer2 = _make_layer(c2, c3, n_blocks=1, stride=2) # (B, 128, 50, 50)
        self.layer3 = _make_layer(c3, c4, n_blocks=1, stride=2) # (B, 256, 25, 25)
        self.layer4 = _make_layer(c4, c5, n_blocks=1, stride=2) # (B, 512, 13, 13)
    ...
    def forward(self, flow: torch.Tensor, w: torch.Tensor) -> torch.Tensor: 
        ...
        x = self.layer2(x)      # (B, 128, 50, 50)
        x = self.layer3(x)      # (B, 256, 25, 25)
