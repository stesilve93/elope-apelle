...
class MultiModalVelocityEstimatorWithFlow(nn.Module):
    ...
    def create_model(
        use_attention: bool=True, device: str="cpu", dropout: float=0.15, 
        use_physics_aware: bool=True, flow_height: int=200, flow_width: int=200
    ):
...
#     # Create model
#     model = MultiModalVelocityEstimatorWithFlow.create_model(flow_height=200, flow_width=200)
...
#     model = MultiModalVelocityEstimatorWithFlow.create_model()
#     model.eval()
